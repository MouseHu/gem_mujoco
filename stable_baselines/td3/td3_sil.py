    ...
    def setup_model(self):
        with SetVerbosity(self.verbose):
            ...
            with self.graph.as_default():
                ...
                self.sil = SelfImitation(self.processed_obs_ph, qf1, qf2, self.policy_out, ac_space=self.action_space)

                self.sil.set_loss_weight(0.1)
                self.sil.build_train_op(qvalues_params, sil_optimizer, self.learning_rate_ph)
    ...
    def learn(self, total_timesteps, callback=None, eval_interval=10000,
        ...
        with SetVerbosity(self.verbose), TensorboardWriter(self.graph, self.tensorboard_log, tb_log_name, new_tb_log) \
            ...
            for step in range(total_timesteps):
                ...
                self.sil.step(obs_, action, reward_, done)
                obs = new_obs
